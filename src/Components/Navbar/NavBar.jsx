...
export default function NavBar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`scroll-navbar [backdrop-filter: blur(15px);] flex min-h-screen w-1/3 flex-col items-start justify-start space-y-6 bg-inherit py-6 backdrop-blur transition-all duration-200 px-2${
          mobileToggleisOpen
