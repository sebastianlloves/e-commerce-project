...
export default function NavBar() {
  ...
  return (
    ...
    >
      <nav className="z-10 flex h-full font-bold w-full max-w-7xl items-center justify-between  px-8">
        <MobileMenuToggle
      ...
      <div
        className={`scroll-navbar lg:hidden [backdrop-filter: blur(15px);] flex min-h-screen w-1/3 flex-col items-start justify-start space-y-6 bg-inherit py-6 backdrop-blur transition-all duration-200 px-2${
          mobileToggleisOpen
